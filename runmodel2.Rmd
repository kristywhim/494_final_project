...
manhattanPlot(result1$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc1$Score.pval, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL) 
```
...
manhattanPlot(result2$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc2$Score.pval, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   
```
...
manhattanPlot(result3$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc3$Score.pval, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   
```
...
manhattanPlot(result4$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc4$Score.pval, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 5e-5, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   
```
