...
## correlated
cor_geno <- cor_geno[,1:1000]
## uncorrelated
uncor_geno <- uncor_geno[,1:1000]
...
# associative y: corr (based on "rs10910097" and "rs4662057")
y_cor_asso <- cor.geno[,"rs10910097"]*3 + cor.geno[,"rs4662057"] * 3 + rnorm(165, mean = 50, sd = 2)

# associative y: uncorr
y_uncor_asso <- uncor.geno[,"rs10910097"]*3 + uncor.geno[,"rs4662057"] * 3 + rnorm(107, mean = 50, sd = 2)
```
