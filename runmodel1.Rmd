...
```{r uncorr-null-LMM}
# Step1: read in
geno1 <- GdsGenotypeReader(filename = "./plinklmm_1/uncor_null.gds")
...
manhattanPlot(result1$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc1$Score.pval, rep(1,999), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL) 
```
...
```{r uncorr-asso-LMM}
# Step1: read in
geno2 <- GdsGenotypeReader(filename = "./plinklmm_1/uncor_asso.gds")
...
manhattanPlot(result2$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc2$Score.pval, rep(1,999), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   
```
...
```{r corr-NULL-LMM}
# Step1: read in
geno3 <- GdsGenotypeReader(filename = "./plinklmm_1/cor_null.gds")
...
manhattanPlot(result3$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc3$Score.pval, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   
```
...
```{r corr-asso-LMM}
# Step1: read in
geno4 <- GdsGenotypeReader(filename = "./plinklmm_1/cor_asso.gds")
...
manhattanPlot(result4$P.Value, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   

manhattanPlot(assoc4$Score.pval, rep(1,1000), ylim = c(0, 7), trunc.lines = FALSE, signif = 1e-4, thinThreshold=NULL, pointsPerBin=10000, col=NULL)   
```
